...
// The following tests require McashBox >= 2.1.x
// and Quickstart (https://github.com/tronprotocol/docker-tron-quickstart)
...
contract('MetaCoin', function (accounts) {
  ...
  it("should send coins from account 0 to 3 and verify that a Transfer event has been emitted", function (done) {
    assert.isTrue(!!accounts[3], 'accounts[1] does not exist. Use Tron Quickstart!');
  ...
  it("should send coins from account 0 to 1", async function () {
    assert.isTrue(!!accounts[1], 'accounts[1] does not exist. Use Quickstart!');
